      ...
      <div className="container-main section-padding">
        <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-8 text-center text-slate-300">
          ...
          <div>
            <Link
              to="/shop"
              className="mt-5 inline-flex rounded-xl bg-linear-to-r from-violet-500 to-cyan-500 px-5 py-2.5 text-white"
            >
              Back to Shop
            </Link>
          </div>
          ...
          {!orderSuccess ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <input
                ...
                className="w-full max-w-xs rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white"
              />
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link
                  to="/cart"
                  className="inline-flex items-center justify-center rounded-xl border border-white/10 bg-white/5 px-6 py-3 font-semibold text-slate-200"
                >
                  Back to Cart
                </Link>
              </div>
            ...
            <div className="space-y-6 text-center">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-linear-to-r from-violet-500 to-cyan-500 px-6 py-3 font-semibold text-white"
              >
                Track Order
              </Link>
              <InvoiceActions
